 ...
 * from uncontrolled thread creation.
 * 
 * Thread Pools:
 * - IO_POOL: For file I/O operations (export, import)
 * - COMPUTE_POOL: For CPU-intensive operations (indexing, search)
 * - SCHEDULED_POOL: For scheduled/delayed tasks
 * 
 * @ThreadSafe Singleton implementation with proper shutdown hooks
 */
public class ThreadPoolManager {
     ...
     * Thread-safe initialization without synchronization overhead on subsequent
     * calls.
     * 
    ...
    /**
     * Get ExecutorService for I/O operations (file export/import).
     * 
     * @return ExecutorService for I/O tasks
     */
    ...
    /**
     * Submit a task to the I/O pool and return a Future.
     * 
    ...
    /**
     * Check if all thread pools are shut down.
     * 
